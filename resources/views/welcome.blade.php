<x-app-layout>
    <main class="sm:mt-24">
        <div class="mx-auto max-w-7xl text-body">
            <div class="lg:grid lg:grid-cols-12 lg:gap-8">
                <div
                    class="px-4 sm:px-6 sm:text-center md:mx-auto md:max-w-2xl lg:col-span-6 lg:flex lg:items-center lg:text-left">
                    <div>
                        <h1 class="mt-4 text-4xl font-medium tracking-tight">
                            Johan Bothma's <span class="text-cyan-400">CRUD</span></h1>
                        <p class="mt-12 text-base">This is a simple CRUD system built on
                            Livewire,
                            with Breeze for Authentication, and TailwindCSS for styling. <br /><br />Simply fill in the
                            form
                            to
                            create a user. You will receive an email address that your information has been captured
                            onto the system. To view all information, simply login. The username and password is
                            prefilled. There you can view, update and delete information.</p>

                        <p class="mt-8 text-sm leading-6 text-gray-500">Follow the
                            <x-inline-link
                                href="/readme"
                                text="README"
                            /> link to find out more about this system and the technical aspects of it.
                        </p>
                        <p class="mt-3 text-sm leading-6 text-gray-500">Feel free to take a look at my
                            <x-inline-link
                                href="/cv"
                                text="CV"
                            /> here.
                        ...
                        @if (!Auth::user())
                            <dl class="mt-8 ml-6 text-sm text-gray-500">
                                <div class="mt-6">
                                    <dd class="flex">
                                        <svg
                                        ...
                                        <span class="ml-3">
                                            Having trouble finding the login button?
                                            <x-inline-link
                                                href="/login"
                                                text="Login here"
                                            />
                        ...
                        @endif
                        <p class="mt-8 text-base font-medium sm:mt-10">Built with</p>
                        <div class="mt-5 w-full sm:mx-auto sm:max-w-lg lg:ml-0">
                            <div class="flex flex-wrap items-center justify-between space-x-4 space-y-4">
                                        ...
                                        >
                                            ...
                                            >
                                                <g
                                                    ...
                                                    transform="translate(-116.000000, -134.000000)"
                                                >
                                                    <g
                                                        id="Group-3"
                                                        transform="translate(115.000000, 136.000000)"
                                                    >
                                                        <g
                                                            id="Livewire"
                                                            transform="translate(65.535000, 5.881000)"
                                                            fill-rule="nonzero"
                                                        >
                                                            <path
                                                        ...
                                                        <g
                                                            id="Jelly"
                                                            style="transform: translateY(-2.72651%);"
                                                        >
                                                            <path
                                ...
                                <div class="flex justify-center px-1">
                                    <a
                                        href="https://livewire-wireui.com"
                                ...
                                <div class="flex justify-center px-1">
                                    <a
                                        href="https://laracasts.com/series/livewire-basics"
                                        target="_blank"
                                    >
                                        <img
                ...
                <div class="rounded-md bg-white p-8 shadow-md md:mx-auto md:max-w-2xl lg:col-span-6">
