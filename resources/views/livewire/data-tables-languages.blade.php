<div>
    ...
    <div class="mx-auto flex max-w-7xl justify-between px-4 pb-8 sm:px-6 lg:px-8">
        <h1 class="text-3xl font-medium leading-tight tracking-tight text-body">Languages</h1>
        ...
        <button
            ...
            wire:click='$emit("openModal", "create-language")'
        >Add Language</button>
    </div>
                                    ...
                                    <tr class="divide-x divide-gray-200">
                                        ...
                                        <td class="whitespace-nowrap py-4 pl-4 pr-4 text-sm text-gray-500 sm:pr-6">
                                            ...
                                            <button
                                                ...
                                                wire:click='$emit("openModal", "edit-language", @json($l))'
