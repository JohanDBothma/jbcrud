<div>
    ...
    <div class="mx-auto flex max-w-7xl justify-between px-4 pb-8 sm:px-6 lg:px-8">
        <h1 class="text-3xl font-medium leading-tight tracking-tight text-body">Dashboard</h1>
    </div>
    <div class="px-4 sm:px-6 lg:px-8">
        <div class="relative my-1 rounded-md">
            ...
            <input
                wire:model="search"
                type="search"
                placeholder="Search for any name or email"
                        ...
                        <table class="min-w-full divide-y divide-gray-300">
                            <thead class="bg-gray-50">
                                <tr class="divide-x divide-gray-200">
                                    <th
                                        scope="col"
                                        class="w-1/12 py-3.5 pl-4 pr-4 text-left text-sm font-normal text-gray-900 sm:pl-6"
                                    >
                                    ...
                                    >
                                        <div class="flex items-center">
                                            <button wire:click="sortBy('surname')">
                                                Surname
                                            </button>
                                            <x-sort-icon
                                                field="surname"
                                    ...
                                    <th
                                        scope="col"
                                        class="w-1/12 px-4 py-3.5 text-left text-sm font-semibold text-gray-900"
                                    >Language</th>
                                    <th
                                        scope="col"
                                        class="w-1/12 px-4 py-3.5 text-left text-sm font-semibold text-gray-900"
                            ...
                            <tbody class="divide-y divide-gray-200 bg-white">
                                @foreach ($users as $u)
                                    <tr class="divide-x divide-gray-200">
                                        <td
                                            class="truncate whitespace-nowrap py-4 pl-4 pr-4 text-sm font-medium text-gray-900 sm:pl-6">
                                            {{ $u->name }}</td>
                                        <td
                                            class="truncate whitespace-nowrap py-4 pl-4 pr-4 text-sm font-medium text-gray-900 sm:pl-6">
                                            {{ $u->surname }}</td>
                                        <td class="truncate whitespace-nowrap p-4 text-sm text-gray-500">
                                            {{ $u->email }}</td>
                                        <td class="truncate whitespace-nowrap p-4 text-sm text-gray-500">
                                            {{ $u->languagename }}</td>
                                        <td class="truncate whitespace-nowrap p-4 text-sm text-gray-500">
                                            {{ $u->interestslist }}</td>
                                        <td
                                            class="truncate whitespace-nowrap py-4 pl-4 pr-4 text-sm text-gray-500 sm:pr-6">

                                            <button
                                                class="text-cyan-600 hover:text-cyan-900"
                                                wire:click='$emit("openModal", "edit-user", @json($u))'
                                            >Edit User</button>
