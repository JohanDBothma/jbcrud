@if ($hasErrors($errors))
    <div
        ...
        <div class="flex items-center border-b-2 border-negative-400 pb-3 dark:border-negative-700">
            <x-dynamic-component
                :component="WireUi::component('icon')"
                class="mr-3 h-5 w-5 shrink-0 text-negative-400 dark:text-negative-600"
