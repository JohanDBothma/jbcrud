...
>
    ...
    <div class="relative">
        ...
        <x-dynamic-component
            ...
            class="!dark:text-transparent cursor-pointer overflow-hidden pl-10 !text-transparent selection:bg-transparent"
            x-ref="input"
            x-on:click="toggle"
            x-on:focus="open"
                        ...
                        >
                            @if ($icon)
                                <x-dynamic-component
                                    ...
                                    :name="$icon"
                                    class="mr-1 h-6 w-6 text-gray-400 dark:text-gray-600"
                                />
                            @endif

                            <span
                                class="truncate text-sm text-secondary-700 dark:text-secondary-400"
                                x-show="!isEmpty()"
                        ...
                        >
                            <div class="hide-scrollbar flex items-center gap-2 overflow-x-auto">
                                ...
                                >
                                    ...
                                    >
                                        <span
                                            class="text-small inline-flex items-center rounded-full border border-secondary-200 bg-secondary-100 py-0.5 pl-2 pr-0.5 text-secondary-700 shadow-sm dark:border-none dark:bg-secondary-700 dark:text-secondary-400"
                                        >
                                            <span
                ...
                <div class="absolute inset-y-0 right-0 flex items-center gap-x-2 pr-2">
                    @if ($clearable && !$readonly && !$disabled)
                        ...
                        >
                            <x-dynamic-component
                                :component="WireUi::component('icon')"
                                class="h-6 w-6 pr-2 text-secondary-400 hover:text-negative-400"
                                name="x"
                            />
                        </button>
                    @endif
    ...
    >
        ...
        >
            ...
            >
                <div
                    class="animate-linear-progress absolute h-0.5 rounded-full bg-primary-500"
                    style="width: 30%"
            ...
            @unless($hideEmptyMessage)
                <div
                    class="cursor-pointer py-12 px-3 text-center text-secondary-500 sm:py-2 sm:px-3 sm:text-left"
